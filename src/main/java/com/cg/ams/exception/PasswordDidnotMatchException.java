...
public class PasswordDidnotMatchException extends RuntimeException {
	...
	public PasswordDidnotMatchException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}

	public PasswordDidnotMatchException(String message, Throwable cause, boolean enableSuppression,
